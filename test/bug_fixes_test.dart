...
void main() {
  group('Bug Fix Tests', () {
    ...
    group('Fallback Engine Depth Cap (TEST C)', () {
      test('SimpleBotService depth is capped at 3, completes under ANR threshold', () async {
        final stopwatch = Stopwatch()..start();
      ...
      test('SimpleBotService at depth 3 returns valid move from midgame', () async {
        // Sicilian Defense position - more complex than starting position
        const midgameFen = 'r1bqkbnr/pp1ppppp/2n5/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R w KQkq - 2 3';
      ...
      test('LightweightEngineService depth is capped at 3, completes under ANR threshold', () async {
        final stopwatch = Stopwatch()..start();
      ...
      test('LightweightEngineService at depth 3 returns valid move from midgame', () async {
        // Italian Game position
        const midgameFen = 'r1bqk1nr/pppp1ppp/2n5/2b1p3/2B1P3/5N2/PPPP1PPP/RNBQK2R w KQkq - 4 4';
